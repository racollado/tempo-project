...
import { IoPlaySkipBack, IoPlaySkipForward } from "react-icons/io5/index.js";
                ...
                <div id="song-info" className="max-w-[35rem] mx-auto bg-offblack text-white p-6 pr-4 text-center rounded-xl mb-3">
                    <div className="flex">
                        <img className="h-32 w-32 md:h-64 md:w-64 mr-2 my-auto" 
                            src={`https://tempoproject.s3.amazonaws.com/covers/cover${song['id']}.jpg`}  
                            alt="album cover"/>
                    ...
                    <div className="flex mt-5 mx-auto">
                        ...
                        <audio 
                            ...
                            src={`https://tempoproject.s3.amazonaws.com/songs/song${song['id']}.mp3`}  
